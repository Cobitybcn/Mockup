...
final class RequestSecurity
{
    ...
    {
        return '/^(?:account|admin_[a-z0-9_]+|analyze|artist_profile|artwork(?:_details)?|assistant_api|camera_studio|complete_root_views|connections|core_review|curated_mockups|dashboard|delete_[a-z0-9_]+|fichas(?:_reconcile)?|generate_(?:mockup(?:_[a-z0-9_]+)?|one_mockup_from_composed_admin_prompt)|merge_artwork_groups|meta_[a-z0-9_]+|mockup_[a-z0-9_]+|pinterest_[a-z0-9_]+|prepare_publication|publication|reanalyze|regenerate_mockup_proposals|reorder_series(?:_artworks)?|report|root_album|save_mockup_combination_evaluation|select_root|series|social_media_(?:catalog|schedule)|start_generate|toggle_[a-z0-9_]+|upload_(?:existing_root|external_mockup)|video_(?:editor_start|final_artwork|final_upload|reference_upload)|website_(?:board_action|catalog|studio_notes)|world_mother_studio)\.php$/i';
    }
}
