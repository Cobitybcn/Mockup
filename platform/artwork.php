        ...
        <div class="workspace"<?= $bilingualExperiment ? ' data-bilingual-editor data-entity-type="artwork" data-entity-id="' . (int)$id . '" data-english-status="' . h((string)($artworkEnglishEditorial['status'] ?? 'unprepared')) . '" data-csrf="' . h(Auth::csrfToken('bilingual_editorial')) . '" data-endpoint="bilingual_editorial.php"' : '' ?>>
            ...
            <?php if ($bilingualExperiment): ?>
                ...
                $bilingualEditorialFields = [
                    ...
                    ['key' => 'influences_analysis', 'es' => 'Análisis Según Influencias del Artista', 'en' => 'Analysis According to the Artist\'s Influences', 'description' => true, 'es_placeholder' => 'Qué afinidades declaradas sostiene esta obra y cómo. Vacío es válido: la selección es la regla…', 'en_placeholder' => 'Which declared affinities this artwork sustains, and how. Empty is valid…'],
