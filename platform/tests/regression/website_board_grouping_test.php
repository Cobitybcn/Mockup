...
function run_website_board_grouping_regression_tests(): void
{
    ...
    $pdo->exec("INSERT INTO artwork_groups VALUES (10,70,101,'Crimson Markers','active')");
    ...
    TestHarness::assertSame(2, count($artworks), 'el picker no repite las dos filas de una obra fusionada');
