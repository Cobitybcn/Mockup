...
$rootPath = $rootFile ? __DIR__ . '/results/' . $rootFile : '';
$rootBase = $rootFile ? pathinfo($rootFile, PATHINFO_FILENAME) : '';
$meta = $rootBase ? read_json_file(__DIR__ . '/results/' . $rootBase . '.meta.json') : [];
$analysis = $rootBase ? read_json_file(__DIR__ . '/results/' . $rootBase . '.analysis.json') : [];
